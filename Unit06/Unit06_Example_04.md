...
其中速率常數符號 $k_{ij}$ 表示**從成分 $j$ 轉化至成分 $i$** 的一次反應速率常數（min⁻¹）。
...
$$
\mathbf{A}_{kin} = \begin{bmatrix} -(k_{21}+k_{31}) & k_{12} & k_{13} & 0 & 0 & 0 \\ k_{21} & -(k_{12}+k_{32}) & k_{23} & 0 & 0 & 0 \\ k_{31} & k_{32} & -(k_{13}+k_{23}+k_{43}) & k_{34} & 0 & 0 \\ 0 & 0 & k_{43} & -(k_{34}+k_{54}+k_{64}) & k_{45} & k_{46} \\ 0 & 0 & 0 & k_{54} & -(k_{45}+k_{65}) & k_{56} \\ 0 & 0 & 0 & k_{64} & k_{65} & -(k_{46}+k_{56}) \end{bmatrix}
$$

代入數值後：

$$
\mathbf{A}_{kin} = \begin{bmatrix} -0.30 & 0.10 & 0.05 & 0 & 0 & 0 \\ 0.20 & -0.20 & 0.05 & 0 & 0 & 0 \\ 0.10 & 0.10 & -0.30 & 0.10 & 0 & 0 \\ 0 & 0 & 0.20 & -0.35 & 0.10 & 0.20 \\ 0 & 0 & 0 & 0.05 & -0.20 & 0.10 \\ 0 & 0 & 0 & 0.20 & 0.10 & -0.30 \end{bmatrix}
$$
...
$$
\mathbf{A} = \begin{bmatrix} -0.30 & 0.10 & 0.05 & 0 & 0 & 0 \\ 0.20 & -0.20 & 0.05 & 0 & 0 & 0 \\ 0.10 & 0.10 & -0.30 & 0.10 & 0 & 0 \\ 0 & 0 & 0.20 & -0.35 & 0.10 & 0.20 \\ 0 & 0 & 0 & 0.05 & -0.20 & 0.10 \\ 1 & 1 & 1 & 1 & 1 & 1 \end{bmatrix}, \quad \mathbf{b} = \begin{bmatrix} 0 \\ 0 \\ 0 \\ 0 \\ 0 \\ 2.0 \end{bmatrix}
$$
